...
<template>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-12">
        <RouterLink to="/proveedores/crear">Crear Nuevo</RouterLink>
      </div>
    </div>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr v-for="(proveedore, index) in proveedores.values()" :key="proveedore.id">
            ...
            <td>
              <button class="btn btn-link" @click="toEdit(proveedore.id)">Editar</button>
              <button class="btn btn-link" @click="toDelete(proveedore.id)">Eliminar</button>
            </td>
          </tr>
        </tbody>
      </table>
